(function() {
  ...
  function setBrowser(browserName) {
    var toRemove = browserName === 'chrome' ? 'firefox' : 'chrome';
    document.body.classList.remove('generic', toRemove);
  ...
  Array.from(document.querySelectorAll('.switch')).map(function(el) {
    el.addEventListener('click', function(event) {
      ...
      if (bodyClasses.contains('chrome')) {
        setBrowser('firefox');
      } else if (bodyClasses.contains('firefox')) {
        setBrowser('chrome');
      }
    });
  });
